...
class ConnectionViewController: UIViewController, UITextViewDelegate {
    ...
    var connected = false;
    var pinViewController : UIViewController!;
...
//    }
    ...
    func mqttEventCallback( status: AWSIoTMQTTStatus )
    {
        ...
        dispatch_async( dispatch_get_main_queue()) {
            ...
            case .Connected:
                ...
                tabBarViewController.viewControllers = [ self, self.pinViewController, self.subscribeViewController ]
                //
                // Register the device shadows once connected.
                //
                AWSApiManager.sharedInstance.subscribeToShadow(thingName);
                
                //
                // Two seconds after registering the device shadows, retrieve their current states.
                //
                //NSTimer.scheduledTimerWithTimeInterval( 2.5, target: self, selector: #selector(AWSApiManager.sharedInstance.getThingState), userInfo: nil, repeats: false )
    ...
    override func viewDidLoad() {
        ...
        let tabBarViewController = tabBarController as! IoTSampleTabBarController
        pinViewController = tabBarViewController.viewControllers![1]
        ...
        // Init IOT
        //
        AWSApiManager.sharedInstance.iotDataManager = AWSIoTDataManager.defaultIoTDataManager()
...
//        let defaults = NSUserDefaults.standardUserDefaults()
        ...
        //
        AWSApiManager.sharedInstance.iotDataManager.connectUsingWebSocketWithClientId( uuid, cleanSession:true, statusCallback: mqttEventCallback)
